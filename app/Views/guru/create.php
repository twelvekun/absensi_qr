<?= view('layout/header', ['title' => 'Tambah Data Guru']) ?>
<?= view('layout/sidebar') ?>
<?= view('layout/topbar') ?>
...
<div class="card">
    <h3 style="margin-top: 0; border-bottom: 2px solid #f4f7f6; padding-bottom: 15px;">Form Tambah Guru Baru</h3>
    
    <form action="<?= base_url('guru/store') ?>" method="post">
        <div class="form-group">
            <label>NUPTK / NIP</label>
            <input type="text" name="nuptk" class="form-control" placeholder="Masukkan NUPTK atau NIP" required autofocus>
        </div>
        ...
        <div class="btn-group">
            <a href="<?= base_url('guru') ?>" class="btn btn-back">Kembali</a>
