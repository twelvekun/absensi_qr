<?= view('layout/header', ['title' => 'Detail Guru']) ?>
<?= view('layout/sidebar') ?>
<?= view('layout/topbar') ?>
...
<div class="card">
    ...
    <h3 style="margin: 0 0 5px 0; color: #333;"><?= $guru['nama_guru'] ?></h3>
    <p style="margin: 0 0 20px 0; color: #777; font-size: 14px;">Data Identitas Tenaga Pendidik</p>

    <div class="detail-info">
        <div class="info-row">
            <span class="info-label">NUPTK / NIP</span>
            <span class="info-value"><?= $guru['nuptk'] ?></span>
        </div>
        <div class="info-row">
            <span class="info-label">Nama Lengkap</span>
            <span class="info-value"><?= $guru['nama_guru'] ?></span>
        </div>
        </div>

    <a href="<?= base_url('guru') ?>" class="btn-back"><i class="fas fa-arrow-left"></i> Kembali ke Data Guru</a>
</div>
